...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { data_nascimento: @pessoa.data_nascimento, nome: @pessoa.nome, sexo: @pessoa.sexo }
    end
  ...
  test "should update pessoa" do
    put :update, id: @pessoa, pessoa: { data_nascimento: @pessoa.data_nascimento, nome: @pessoa.nome, sexo: @pessoa.sexo }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
