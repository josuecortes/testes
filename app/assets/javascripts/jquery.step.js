...
;(function($) {
  ...
  var methods = {
    init: function(settings) {
      ...
      var self       = this,
          that       = $(this),
          attributes = { href: 'javascript:void(0);', 'class': 'button-back btn btn-info', html: self.opt.backLabel };
      ...
      var self       = this,
          that       = $(this),
          attributes = { href: 'javascript:void(0);', 'class': 'button-next btn btn-info', html: self.opt.nextLabel };
